...
@interface XWHBulletinViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation XWHBulletinViewController
...
- (void)moreBtnAction:(id)sender
{
    ...
    [self.popoverContentView setData:@[@"发布公告"]];
